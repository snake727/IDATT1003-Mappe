...
class TrainSchedulePrinterTest {
  ...
  /* Using the @BeforeEach annotation to make sure that the tsp and trainDispatchSystem
     objects are created before each test, so that we don't have to create them in each test. */
  ...
  @Test
  @DisplayName("Check if constructor works")
  void testConstructor() {
    // Checking if the constructor creates a new TrainSchedulePrinter object.
    assertNotNull(tsp);
  }

  @Test
  @DisplayName("Check if printSchedule method works")
  void testPrintSchedule() {
    // Creating new TrainDeparture objects
    TrainDeparture trainDeparture1 = new TrainDeparture(LocalTime.of(17, 30), "L1",
          1, "Oslo", "1", Duration.ofMinutes(0));
    TrainDeparture trainDeparture2 = new TrainDeparture(LocalTime.of(12, 45), "L2",
          2, "Trondheim", "2", Duration.ofMinutes(0));
    TrainDeparture trainDeparture3 = new TrainDeparture(LocalTime.of(20, 0), "L3",
          3, "Bergen", "3", Duration.ofMinutes(0));
    TrainDeparture trainDeparture4 = new TrainDeparture(LocalTime.of(14, 15), "L4",
          4, "Stavanger", "4", Duration.ofMinutes(0));
    TrainDeparture trainDeparture5 = new TrainDeparture(LocalTime.of(10, 30), "L5",
          5, "Kristiansand", "5", Duration.ofMinutes(0));
    TrainDeparture trainDeparture6 = new TrainDeparture(LocalTime.of(3, 45), "L6",
          6, "Bodø", "6", Duration.ofMinutes(0));
  ...
  void testPrintScheduleWithDelay() {
    // Creating new TrainDeparture objects
    TrainDeparture trainDeparture1 = new TrainDeparture(LocalTime.of(17, 30), "L1",
          1, "Oslo", "1", Duration.ofHours(0).plusMinutes(0));
    TrainDeparture trainDeparture2 = new TrainDeparture(LocalTime.of(12, 45), "L2",
          2, "Trondheim", "2", Duration.ofMinutes(40));
    TrainDeparture trainDeparture3 = new TrainDeparture(LocalTime.of(20, 0), "L3",
          3, "Bergen", "3", Duration.ofHours(3).plusMinutes(2));
    TrainDeparture trainDeparture4 = new TrainDeparture(LocalTime.of(14, 15), "L4",
          4, "Stavanger", "4", Duration.ofHours(4));
    TrainDeparture trainDeparture5 = new TrainDeparture(LocalTime.of(10, 30), "L5",
          5, "Kristiansand", "5", Duration.ofHours(2).plusMinutes(15));
    TrainDeparture trainDeparture6 = new TrainDeparture(LocalTime.of(3, 45), "L6",
          6, "Bodø", "6", Duration.ofMinutes(10));
